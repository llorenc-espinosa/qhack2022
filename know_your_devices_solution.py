...
def compare_circuits(num_wires, params):
    ...
    dev_pure = qml.device('default.qubit',wires=num_wires,shots=None)
    dev_mixed = qml.device('default.mixed',wires=num_wires,shots=None)
